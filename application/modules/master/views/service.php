...
<script>
	...
	function crud ( mode, target ) {
		...
		url = "<?php echo site_url('master/service');?>/"+mode;

		if ( mode=='c' ) {
			var is_allow = <?php echo (is_allow('c', 'master', 'service'))?1:0; ?>;
			if ( !is_allow ) {
		...
		if ( mode=='u' ) {
			var is_allow = <?php echo (is_allow('u', 'master', 'service'))?1:0; ?>;
			if ( !is_allow ) {
				dhtmlx.alert({title:"<?php echo l('notification');?>", type:"alert-error", text:"<?php echo l('permission_failed_crud');?>"});
				return false;
			}
		...
		if ( mode=='d' ) {
			var is_allow = <?php echo (is_allow('d', 'master', 'service'))?1:0; ?>;
			if ( !is_allow ) {
				dhtmlx.alert({title:"<?php echo l('notification');?>", type:"alert-error", text:"<?php echo l('permission_failed_crud');?>"});
				return false;
			}
