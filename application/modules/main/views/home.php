...
<script type="text/javascript">
	...
	function changeBackground() {
		...
		// $.vegas({ src: '<?php echo base_url();?>assets/images/background/background-02-bj.jpg', fade:1000 });
		$.vegas({ src: '<?php echo base_url();?>assets/images/background/background-02-xyz.jpg', fade:1000 });
	...
	$(function() {
		...
		var branch_name = "<?php echo ''// $this->systems_model->get_branch_name( $this->session->userdata('branch_id') )?>";
		...
		/* $.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_all_yearly')?>', function(data) {
		...
		/* if (company_id==1 && branch_id==1) {			
			$.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_all_monthly')?>', function(data) {
		...
		/* $.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_branch_yearly')?>', function(data) {
		...
		/* if (company_id==1 && branch_id!=1) {			
			$.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_branch_monthly')?>', function(data) {
		...
		/* if (company_id==1 && branch_id!=1) {			
			$.getJSON('<?php echo site_url('shared/dashboard_table_today_phd_updates')?>', function(data) {
		...
		/* if (company_id==1 && branch_id==1) {			
			$.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_routes_all_monthly')?>', function(data) {
		...
		/* $.getJSON('<?php echo site_url('shared/dashboard_pie_total_phd_routes_all_yearly')?>', function(data) {
