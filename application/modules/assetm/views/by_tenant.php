			...
			<div title="GENERAL" style="padding:8px">
				...
				<table>
					<tr>
						...
						<td colspan="2"><input class="easyui-validatebox" type="text" id="customer_code" name="customer_code" style="width:175px; border:1px solid #ccc;" data-options="required:true" disabled /></td>
					</tr>
					<tr>
						<td><label for="customer_name">Name</label></td> 			
						<td colspan="2"><input class="easyui-validatebox" type="text" id="customer_name" name="customer_name" style="width:175px; border:1px solid #ccc;" data-options="required:true" /></td>
					</tr>
					<tr>
						<td><label for="email">Email</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="email" name="email" style="width:175px; border:1px solid #ccc;" data-options="required:false, validType:'email'" /></td>
					</tr>
					<tr>
						<td><label for="contact_person">Contact Person</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="contact_person" name="contact_person" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
				</table>
			</div>
			...
			<div title="ADDRESS" style="padding:8px">
				<table>
					<tr>
						...
						<td colspan="2"><textarea id="address" name="address" style="height:50px; width:355px; border:1px solid #ccc;"></textarea></td>
					</tr>
					<tr>
						<td><label for="phone">Phone</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="phone" name="phone" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="fax">Fax</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="fax" name="fax" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<!--
					<tr>
						<td><label for="country">Country</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="country" name="country" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="state">State</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="state" name="state" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="city">City</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="city" name="city" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="zipcode">Zip Code</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="zipcode" name="zipcode" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					-->
				</table>
			</div>
			<div title="BILLING ADDRESS" style="padding:8px">
				<table>
					<tr>
						...
						<td colspan="2"><textarea id="bill_address" name="bill_address" style="height:50px; width:355px; border:1px solid #ccc;"></textarea></td>
					</tr>
					<tr>
						<td><label for="bill_phone">Phone</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="bill_phone" name="bill_phone" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="bill_fax">Fax</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="bill_fax" name="bill_fax" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
				</table>
			</div>
			<div title="SHIPPING ADDRESS" style="padding:8px">
				<table>
					<tr>
						...
						<td colspan="2"><textarea id="ship_address" name="ship_address" style="height:50px; width:355px; border:1px solid #ccc;"></textarea></td>
					</tr>
					<tr>
						<td><label for="ship_phone">Phone</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="ship_phone" name="ship_phone" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
					<tr>
						<td><label for="ship_fax">Fax</label></td> 		
						<td colspan="2"><input class="easyui-validatebox" type="text" id="ship_fax" name="ship_fax" style="width:175px; border:1px solid #ccc;" data-options="required:false" /></td>
					</tr>
				</table>
			</div>
			<div title="DOCUMENT LOG" style="padding:10px">
...
<script>
	...
	$(function(){  
		$("#grid").datagrid({        
			url:'<?php echo site_url('assetm/by_tenant/r')?>',	
			columns:[[
	...
	function crud ( mode, target ) {
		...
		url = "<?php echo site_url('assetm/by_tenant');?>/"+mode;

		if ( mode=='c' ) {
			var is_allow = <?php echo (is_allow('c', 'assetm', 'by_tenant'))?1:0; ?>;
			if ( !is_allow ) {
		...
		if ( mode=='u' ) {
			var is_allow = <?php echo (is_allow('u', 'assetm', 'by_tenant'))?1:0; ?>;
			if ( !is_allow ) {
				dhtmlx.alert({title:"<?php echo l('notification');?>", type:"alert-error", text:"<?php echo l('permission_failed_crud');?>"});
				return false;
			}
		...
		/* if ( mode=='d' ) {
			var is_allow = <?php echo (is_allow('d', 'assetm', 'by_tenant'))?1:0; ?>;
			if ( !is_allow ) {
				dhtmlx.alert({title:"<?php echo l('notification');?>", type:"alert-error", text:"<?php echo l('permission_failed_crud');?>"});
				return false;
			}
	...
	$(function(){  
		...
		$("#grid2").datagrid({        
			url:"<?php echo site_url('assetm/by_tenant_unit/r')?>",	
			columns:[[
	...
	function crud2 ( mode ) {
		...
		url = "<?php echo site_url('assetm/by_tenant_unit');?>/"+mode;
